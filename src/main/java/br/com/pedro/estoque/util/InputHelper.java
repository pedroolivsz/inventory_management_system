...
public class InputHelper {
    ...
    public static final ValidadorProdutoSimplesImpl VALIDADOR_PRODUTO_SIMPLES = new ValidadorProdutoSimplesImpl();
    ...
    public static String lerNome(String mensagem) {
        ...
        } while(!VALIDADOR_PRODUTO_SIMPLES.validarNome(nome));
        return nome;
    }
    ...
    public static int lerInt(String mensagem) {
        while(true) {
            ...
            if(scan.hasNextInt()) {
                ...
                scan.nextLine();
                if(VALIDADOR_PRODUTO_SIMPLES.validarInt(quantidade)) {
                    return quantidade;
                }
            } else {
